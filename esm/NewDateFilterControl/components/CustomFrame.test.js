...
import { CustomFrame } from '.';import { jsx as ___EmotionJSX } from "@emotion/react";
...
test('renders with default props', () => {
  render(___EmotionJSX(CustomFrame, { onChange: jest.fn(), value: emptyValue }));
...
test('renders since and until with specific date/time', () => {
  render(___EmotionJSX(CustomFrame, { onChange: jest.fn(), value: specificValue }));
...
test('renders since and until with relative date/time', () => {
  render(___EmotionJSX(CustomFrame, { onChange: jest.fn(), value: relativeNowValue }));
...
test('renders since and until with Now option', () => {
  render(___EmotionJSX(CustomFrame, { onChange: jest.fn(), value: nowValue }));
  expect(screen.getAllByText('Now').length).toBe(2);
});

test('renders since and until with Midnight option', () => {
  render(___EmotionJSX(CustomFrame, { onChange: jest.fn(), value: todayValue }));
...
test('renders anchor with date/time option', () => {
  render(___EmotionJSX(CustomFrame, { onChange: jest.fn(), value: relativeTodayValue }));
  expect(screen.getByText('Anchor to')).toBeInTheDocument();
  expect(screen.getByRole('radio', { name: 'NOW' })).toBeInTheDocument();
  expect(screen.getByRole('radio', { name: 'Date/Time' })).toBeInTheDocument();
...
test('triggers onChange when the anchor changes', () => {
  ...
  render(___EmotionJSX(CustomFrame, { onChange: onChange, value: relativeNowValue }));
...
test('triggers onChange when the value changes', () => {
  const onChange = jest.fn();
  render(___EmotionJSX(CustomFrame, { onChange: onChange, value: emptyValue }));
...
test('triggers onChange when the mode changes', () => {
  const onChange = jest.fn();
  render(___EmotionJSX(CustomFrame, { onChange: onChange, value: todayNowValue }));
...
test('triggers onChange when the date changes', async () => {
  const onChange = jest.fn();
  render(___EmotionJSX(CustomFrame, { onChange: onChange, value: specificValue }));
  ...
  expect(onChange).toHaveBeenCalledTimes(2);
});;(function () {var reactHotLoader = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.default : undefined;if (!reactHotLoader) {return;}reactHotLoader.register(emptyValue, "emptyValue", "/Users/bharat.nischal/Desktop/Swiggy/Data Platform/superset/superset-frontend/plugins/plugin-custom-time/src/NewDateFilterControl/components/CustomFrame.test.tsx");reactHotLoader.register(nowValue, "nowValue", "/Users/bharat.nischal/Desktop/Swiggy/Data Platform/superset/superset-frontend/plugins/plugin-custom-time/src/NewDateFilterControl/components/CustomFrame.test.tsx");reactHotLoader.register(todayValue, "todayValue", "/Users/bharat.nischal/Desktop/Swiggy/Data Platform/superset/superset-frontend/plugins/plugin-custom-time/src/NewDateFilterControl/components/CustomFrame.test.tsx");reactHotLoader.register(todayNowValue, "todayNowValue", "/Users/bharat.nischal/Desktop/Swiggy/Data Platform/superset/superset-frontend/plugins/plugin-custom-time/src/NewDateFilterControl/components/CustomFrame.test.tsx");reactHotLoader.register(specificValue, "specificValue", "/Users/bharat.nischal/Desktop/Swiggy/Data Platform/superset/superset-frontend/plugins/plugin-custom-time/src/NewDateFilterControl/components/CustomFrame.test.tsx");reactHotLoader.register(relativeNowValue, "relativeNowValue", "/Users/bharat.nischal/Desktop/Swiggy/Data Platform/superset/superset-frontend/plugins/plugin-custom-time/src/NewDateFilterControl/components/CustomFrame.test.tsx");reactHotLoader.register(relativeTodayValue, "relativeTodayValue", "/Users/bharat.nischal/Desktop/Swiggy/Data Platform/superset/superset-frontend/plugins/plugin-custom-time/src/NewDateFilterControl/components/CustomFrame.test.tsx");})();;(function () {var leaveModule = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.leaveModule : undefined;leaveModule && leaveModule(module);})();